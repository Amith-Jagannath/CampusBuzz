...
export default function Home() {
  ...
  if (status === "loading") {
    return <div className="text-white p-10">Loading...</div>; // Don't render yet
  }
  return (
    <div className="bg-[#0e0b1f] text-white font-sans min-h-screen flex flex-col items-center">
      <header className="w-full max-w-7xl flex items-center justify-start mb-10 pt-20">
