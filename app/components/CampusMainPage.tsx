...
import {
  ...
  getPostsByCollegeId,
} from "../libs/server"; // Assuming these are server-side functions
    ...
    <main className="flex-1 lg:ml-64 lg:mr-80 p-4 md:p-6 space-y-6 min-h-screen bg-black text-white font-sans">
      ...
      <div className="flex space-x-6 border-b border-gray-700 mb-6 text-sm font-medium">
        <button
          ...
          className={`m-2.5 text-gray-400 hover:text-white pb-2 border-b-2 transition-all ${
        ...
        <button
          ...
          className={`text-gray-400 hover:text-white pb-2 border-b-2 transition-all ${
